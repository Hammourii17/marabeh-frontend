    ...
    >
      <div class="flex flex-col justify-center w-[100%] company-modal__questions">
        ...
        <!-- <n-form-item
          ...
          path="acceptsPOS"
        >
          <TToggle v-model="formValue.acceptsPOS" />
        </n-form-item>

        <n-form-item
          class="company-modal__item"
          label="Do you have any financial obligation defaults?"
          path="financialDefaults"
        >
          <TToggle v-model="formValue.financialDefaults" />
        </n-form-item>

        <n-form-item
          class="company-modal__item"
          label="Can you provide any guarantees?"
          path="providesGuarantees"
        >
          <TToggle v-model="formValue.providesGuarantees" />
        </n-form-item>
        ...
        >
          <TSelect
            v-model="formValue.companyActivities"
            title=""
            :options="options.companyActivities"
            class="company-modal__select"
          />
        </n-form-item>
