  ...
  <div class="company-container">
    <div class="company-content__wrapper">
      ...
      <p class="company-desc">
        This step confirms your eligibility as a guarantor on our platform. Review and confirm the
        pre-filled guarantor details.
      </p>
      ...
      >
        <div class="flex flex-col gap-4">
          ...
          <n-form-item
            ref="phoneNumberRef"
            label="Company registered phone number"
            path="companyPhone"
          >
            <n-input
        ...
        <div class="flex items-center justify-between mt-auto">
          ...
          <n-button
            ...
            class="w-[43%] ml-auto border rounded-[12px]"
            size="large"
            type="success"
            @click="submit"
          >
...
<script setup>
  ...
  const formValue = ref({
    companyName: props.guarantor?.name || '',
    companyNumber: props.guarantor?.cr_number || '',
    companyPhone: props.guarantor?.phone || '',
    companyType: null,
  })
  ...
  const submit = () => {
    emit('modalData', formValue.value)
  }
